...
function IndividualArticle({
  ...
  return (
    <div className="px-6 pt-4 pb-2 text-center">
      <button
        className="bg-[#F9500D] hover:bg-black text-black hover:text-[#F9500D] font-medium py-2 px-4 rounded"
      ...
      <div className="mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div className="p-8">
          <div>
            <img
              className="h-96 w-full object-cover rounded mx-auto"
          ...
          <div>
            ...
            {userDetails.role !== "technicalwriter" &&
              article.status === "pending" && (
                <div>
                  <button
                    className="bg-gray-200 rounded-lg px-3 py-1 text-sm font-semibold text-gray-700 mr-2"
          ...
          <a
            href="#"
            className="block mt-1 text-lg leading-tight font-bold text-black hover:underline text-justify"
          >
          ...
          {error && (
            <div className="error text-red-500 font-bold text-center">
              {error}
            </div>
          )}
